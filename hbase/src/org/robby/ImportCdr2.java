			...
			try {
				...
				for (String f : files) {
					...
					while ((s = in.readLine()) != null) {
						...
						*/
						Put p = new Put(row.getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("oaddr"), arr[0].getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("oareacode"), arr[1].getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("daddr"), arr[2].getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("dareacode"), arr[3].getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("ts"), arr[4].getBytes());
						p.add(Bytes.toBytes("data"), Bytes.toBytes("type"), arr[5].getBytes());
						l.add(p);
